...
import { manifest } from './manifest_DiD0E6Bb.mjs';
...
const _page4 = () => import('./pages/features/agentic-crm.astro.mjs');
const _page5 = () => import('./pages/features/ai-visibility-tracker.astro.mjs');
const _page6 = () => import('./pages/features/budget-optimization.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/features/agentic-crm.astro", _page4],
    ["src/pages/features/ai-visibility-tracker.astro", _page5],
    ["src/pages/features/budget-optimization.astro", _page6],
...
const _args = {
    "middlewareSecret": "d0186a4e-4608-41d1-bc81-0607bdbe10ce",

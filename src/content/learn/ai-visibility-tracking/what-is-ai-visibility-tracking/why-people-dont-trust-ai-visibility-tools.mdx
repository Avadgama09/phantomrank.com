...
<ContentImage
  ...
  caption="Most distrust in AI visibility tools comes from black-box methods, vague scores, and a weak link to real outcomes."
  width={1200}
  height={630}
/>
...
<ContentImage
  ...
  caption="Turn the 15 common objections into an evaluation matrix you can use in procurement and client pitches."
  width={1200}
  height={630}
/>
